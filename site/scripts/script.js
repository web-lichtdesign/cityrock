...
(function (cityrock) {
    ...
    cityrock.validateForm = validateForm;
    /**
     *
     *
     * @param form
    ...
    cityrock.validateProfile = validateProfile;
    /**
     *
     *
     */
    ...
    function initializeCourseView() {
        ...
        var dayCounter = $(document).find('input[name=days]').val();
        console.log(dayCounter);
        // add day link
        $('#add-day').on('click', function (event) {
            //console.log("Day counter: " + dayCounter);
            var index = +dayCounter + 1;
            if (index < 6) {
                dayCounter++;
                // set new value for days input
                $(document).find('input[name=days]').val(dayCounter.toString());
                var container = $("<div class='day-container'>");
                $(event.target).before(container);
                var heading = $("<h3 class='inline'>Tag " + index + "</h3><span>(<a class='remove-day'>entfernen</a>)</span>");
                container.append(heading);
                //var label:string = "<label for='date-" + index + "'>Datum</label>";
                //container.append($(label));
                var input = "<div class='form-group'><label for='date-" + index + "' class='col-sm-2 control-label'>Datum</label> <div class='col-sm-10'> <input class='datepicker-cr' type='text'  name='date-" + index + "' class='date'></div></div> ";
                container.append($(input));
                //var label:string = "<label for='start-" + index + "'>Uhrzeit Start</label>";
                //container.append($(label));
                var input = "<div class='form-group'><label for='start-" + index + "' class='control-label col-sm-2'>Uhrzeit Start</label> <div class='col-sm-10'> <input type='text' class='timepicker-cr' id='start-" + index + "' name='start-" + index + "' value='12:00'  /> </div></div>";
                container.append($(input));
                //var label:string = "<label for='end-" + index + "'>Uhrzeit Ende</label>";
                //container.append($(label));
                var input = "<div class='form-group'><label for='end-" + index + "' class='control-label col-sm-2'>Uhrzeit Ende</label> <div class='col-sm-10'> <input type='text' class='timepicker-cr' id='end-" + index + "' name='end-" + index + "' value='14:00'  /> </div></div>";
                container.append($(input));
                var input = "<div class='col-sm-2'></div> <div class='col-sm-10'><button type='button' class='button-date btn btn-primary btn-xs' start='10:00' end='12:00' date-counter='" + index + "'>10 - 12</button>\
    ...
    function initializeUserView() {
         ...
         * @returns {string}
         */
        function createInputField(value, name, type) {
    ...
    function initializeCalendarView() {
        ...
        calendar.fullCalendar({
            ...
            dayClick: function (fullDate, fullDay, jsEvent, view) {
    ...
    cityrock.initializeGroupView = initializeGroupView;
    ...
    cityrock.createNewGroup = createNewGroup;
    ...
    cityrock.deleteGroup = deleteGroup;
    ...
    cityrock.updateGroup = updateGroup;
    ...
    cityrock.changeSelectGroup = changeSelectGroup;
    ...
    cityrock.sendMailToGroup = sendMailToGroup;
    ...
    cityrock.changeSelectGroups = changeSelectGroups;
    ...
    function sendDataToUser(formData) {
    ...
    cityrock.reloadDateButton = reloadDateButton;
})(cityrock || (cityrock = {}));
$(function () {
    'use strict';
