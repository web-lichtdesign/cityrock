...
if ($course['id']) {
    ...
    $content .= "
        ...
        <div class='col-sm-10'>
            <select class='form-control' name='interval' id='interval'><br>
            ";
    ...
    $content .= "
         ...
         <div class='col-sm-2'></div>
         <div class='col-sm-2'>
        <label for='repeat-end-date' class='control-label'>Enddatum</label>
        </div><div class='col-sm-3'>
            <input type='text' name='repeat-end-date' class='datepicker-cr'>
            </div><div class='col-sm-2'>
            <label for='repeat-end-repeat' class='control-label'>Wiederholungen</label>
            </div><div class='col-sm-3'>
            <select name='repeat-end-repeat' class='form-control'>
                <option value=''></option>
