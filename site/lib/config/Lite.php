...
require_once 'lib/config/Lite/Exception/InvalidArgument.php';
require_once 'lib/config/Lite/Exception/Runtime.php';
require_once 'lib/config/Lite/Exception/UnexpectedValue.php';
